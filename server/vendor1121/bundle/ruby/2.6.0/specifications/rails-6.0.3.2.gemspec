...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/releases/tag/v6.0.3.2", "documentation_uri" => "https://api.rubyonrails.org/v6.0.3.2/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "source_code_uri" => "https://github.com/rails/rails/tree/v6.0.3.2" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<activemodel>.freeze, ["= 6.0.3.2"])
    s.add_runtime_dependency(%q<activerecord>.freeze, ["= 6.0.3.2"])
    s.add_runtime_dependency(%q<actionmailer>.freeze, ["= 6.0.3.2"])
    s.add_runtime_dependency(%q<activejob>.freeze, ["= 6.0.3.2"])
    s.add_runtime_dependency(%q<actioncable>.freeze, ["= 6.0.3.2"])
    s.add_runtime_dependency(%q<activestorage>.freeze, ["= 6.0.3.2"])
    s.add_runtime_dependency(%q<actionmailbox>.freeze, ["= 6.0.3.2"])
    s.add_runtime_dependency(%q<actiontext>.freeze, ["= 6.0.3.2"])
    ...
    s.add_dependency(%q<activemodel>.freeze, ["= 6.0.3.2"])
    s.add_dependency(%q<activerecord>.freeze, ["= 6.0.3.2"])
    s.add_dependency(%q<actionmailer>.freeze, ["= 6.0.3.2"])
    s.add_dependency(%q<activejob>.freeze, ["= 6.0.3.2"])
    s.add_dependency(%q<actioncable>.freeze, ["= 6.0.3.2"])
    s.add_dependency(%q<activestorage>.freeze, ["= 6.0.3.2"])
    s.add_dependency(%q<actionmailbox>.freeze, ["= 6.0.3.2"])
    s.add_dependency(%q<actiontext>.freeze, ["= 6.0.3.2"])
